...
const { Cons, Nil } = NumList,
    list1 = Cons({ head: 1, tail: Cons({ head: 2, tail: Cons({ head: 3, tail: Nil }) }) }),
    list2 = Cons({ head: 5, tail: Cons({ head: 10, tail: Cons({ head: 15, tail: Nil }) }) });
...
const list3 = Cons({ head: 100, tail: Cons({ head: 200, tail: Nil }) }),
    zippedShort = PairListWithZip.Zip({ xs: list1, ys: list3 });

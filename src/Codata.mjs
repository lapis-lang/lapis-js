...
function addUnfoldOperation(CodataType, observerMap, name, spec, handlers) {
    ...
    if (typeof spec === 'function') {
        ...
        inSpec = specResult.in;
        outSpec = specResult.out;
    ...
    for (const [observerName, observer] of observerMap.entries()) {
    ...
    CodataType[name] = function(seed) {
        // TODO: Validate seed against inSpec
    ...
    const proxy = new Proxy(instance, {
        get(target, prop, receiver) {
            ...
            if (observer.isContinuation) {
                ...
                // Do NOT memoize - recompute on each call
